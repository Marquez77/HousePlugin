...
public enum MessageEnum {
	...
	House_Create_Fail_There_Is_No_Region("[House] 집 범위가 설정되어 있지 않습니다!"),
	House_Delete_Success("[House] %House_Name% 집을 제거하였습니다!"),
	House_Delete_Fail_Invaild_House("[House] 존재하지 않는 집입니다."),
	Buysign_Set_Success("[House] Buy Sign을 설정하였습니다."),
	Buysign_Set_Fail_The_Sign_Is_Already_Set("[House] 이미 설정한 Buy Sign입니다."),
	Buysign_Destroy("[House] Buy Sign이 파괴되었습니다."),
